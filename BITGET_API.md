...
For this reason `bitgetv3` deliberately does not wrap the v3 ticker/kline channels:
WS candle streaming goes exclusively through the legacy v2 WS (`WsPublicV2.Candle`).
